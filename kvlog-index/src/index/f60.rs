    ...
    fn comparison() {
        for x in [-234.234f64, 0.0, 184.0, 34293949234.0] {
            for y in [-234.234f64, 0.0, 184.0, 34293949234.0] {
                let x_conv = f64_to_f60(x);
                let y_conv = f64_to_f60(y);
